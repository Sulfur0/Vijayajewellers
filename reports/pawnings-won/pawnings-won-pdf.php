...
$pdf->SetTitle('pawnings-won-report');
$pdf->SetSubject('Pawning Won Report');
$pdf->SetKeywords('TCPDF, PDF, pawnings, won');

// set default header data
//logo,logo-width
$pdf->SetHeaderData(null, 0, 'pawnings-won-report  Vijaya Jewellers', '', array(0,64,255), array(0,64,128));
...
if ($result->num_rows > 0) {
	...
	$pdf->MultiCell(40, 7, "Article Name", 0, 'L', 0, 0, '43', $y, true);
	$pdf->MultiCell(35, 7, "Weight", 0, 'L', 0, 0, '83', $y, true);
	$y +=11 ;
	while($row = $result->fetch_assoc()) {
		...
		$pdf->MultiCell(40, 7, $row["pawnArticleType"], 1, 'L', 0, 0, '43', $y, true);
		$pdf->MultiCell(35, 7, $row["pawnNetWeight"]."g ".$row["pawnNetWeightMili"]."mg", 1, 'L', 0, 0, '83', $y, true);
		$y +=11 ;
		$i++;                   
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('pawnings-won-report'.'.pdf', 'I');
