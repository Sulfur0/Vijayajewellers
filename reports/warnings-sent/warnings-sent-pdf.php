...
$pdf->SetTitle('warning-sent-report');
$pdf->SetSubject('Warning Sent Report');
$pdf->SetKeywords('TCPDF, PDF, Warning, Sent');

// set default header data
//logo,logo-width
$pdf->SetHeaderData(null, 0, 'warning-sent-report  Vijaya Jewellers', '', array(0,64,255), array(0,64,128));
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('warning-sent-report'.'.pdf', 'I');
