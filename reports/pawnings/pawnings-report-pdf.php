...
$pdf->SetTitle('pawnings-report');
$pdf->SetSubject('Pawnings Report');
$pdf->SetKeywords('TCPDF, PDF, pawnings, report');

// set default header data
//logo,logo-width
$pdf->SetHeaderData(null, 0, 'pawnings-report  Vijaya Jewellers', '', array(0,64,255), array(0,64,128));
...
$flag = 0;
$i = 0;
$sql = "SELECT * FROM pawnings WHERE ".$condition;
...
if ($result->num_rows > 0) {
	...
	$pdf->MultiCell(15, 7, "Bill No.", 0, 'L', 0, 0, '20', $y, true);
	$pdf->MultiCell(30, 7, "Article Name", 0, 'L', 0, 0, '35', $y, true);
	$pdf->MultiCell(25, 7, "Net Weight", 0, 'L', 0, 0, '65', $y, true);
	$pdf->MultiCell(25, 7, "Gross Weight", 0, 'L', 0, 0, '90', $y, true);
	$pdf->MultiCell(25, 7, "Amount", 0, 'R', 0, 0, '115', $y, true);
	$pdf->MultiCell(22, 7, "Date", 0, 'L', 0, 0, '140', $y, true);
	$pdf->MultiCell(30, 7, "Customer Name", 0, 'L', 0, 0, '162', $y, true);
	$y +=11 ;
	while($row = $result->fetch_assoc()) {
		...
		*/
		...
		$customer = $row["pawnFirstName"]." ".$row["pawnLastName"];
		...
		$pdf->MultiCell(15, 7, $row["pawnBillNo"], 1, 'L', 0, 0, '20', $y, true);
		$pdf->MultiCell(30, 7, $row["pawnArticleType"], 1, 'L', 0, 0, '35', $y, true);
		$pdf->MultiCell(25, 7, $netWeight, 1, 'L', 0, 0, '65', $y, true);
		$pdf->MultiCell(25, 7, $grossWeight, 1, 'L', 0, 0, '90', $y, true);
		$pdf->MultiCell(25, 7, $price, 1, 'R', 0, 0, '115', $y, true);
		$pdf->MultiCell(22, 7, $pawnDate, 1, 'L', 0, 0, '140', $y, true);
		$pdf->MultiCell(30, 7, $customer, 1, 'L', 0, 0, '162', $y, true);
		$y +=11 ;
		$i++;
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('pawnings-report'.'.pdf', 'I');
